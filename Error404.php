...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Dashboard Times - Error 404</title>
            ...
            <div class="card-content">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12">
                        <!--<a onclick="Volver()" class="btn btn-primary btn-block" style="color: white"><i class="ft-arrow-left"></i> Regresar</a>-->
                        <a href="index" class="btn btn-primary btn-block"><i class="ft-arrow-left"></i> Regresar</a>
                    </div>
                </div>
            </div>
        </div>
