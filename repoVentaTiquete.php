...
if (count($_POST)) {
  ...
  $sqlQuery = "CALL SELECT_REPORTE_VENTA_TIQUETE (?, ?, ?)";
  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-12 col-12 mb-1">
        <h3 class="content-header-title" align="center">Reporte de Venta de Tiquete</h3>
      </div>
    </div>
...
function showData() {
  ...
  $.post('repoVentaTiquete.php',params,function(retval){
    tabla.rows().remove();
    datos=retval.datos;
